...
#define FIREBASE_HOST "ledblink-ccfbf-default-rtdb.firebaseio.com"                         // the project name address from firebase id
#define FIREBASE_AUTH "9EgQ4CltApv1dt7FzUFXjn5rBZpVriUxKo9cvwzQ"                    // the secret key generated from firebase
#define WIFI_SSID "Redmii"                                          // input your home or public wifi name 
#define WIFI_PASSWORD "12345678900"                                    //password of wifi ssid
String fireStatus = "";                                                     // led status received from firebase
int led = D2;                                                                // for external led
void setup() {
  Serial.begin(9600);
  delay(1000);
